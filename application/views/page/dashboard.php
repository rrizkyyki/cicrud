						...
						<div class="row align-items-center">
							...
							<div class="col-sm-6 col-12 text-sm-end">
								<div class="mx-n1">
									...
									<button type="button" data-bs-toggle="modal" data-bs-target="#petugasModal" class="btn d-inline-flex btn-sm btn-primary mx-1">
										<span class=" pe-2">
									...
									<button type="button" data-bs-toggle="modal" data-bs-target="#siswaModal" class="btn d-inline-flex btn-sm btn-primary mx-1">
										<span class=" pe-2">
											<i class="bi bi-plus"></i>
										</span>
								...
								<tbody>
									<?php foreach ($siswa as $item) { ?>
										<tr>
											...
											<td class="text-end">
												<button type="button" data-url="<?php echo base_url(); ?>index.php/updateSiswa/<?= $item->id ?>" data-nama="<?= $item->nama ?>" data-alamat="<?= $item->alamat ?>" data-no_telp="<?= $item->no_telp ?>" data-bs-toggle="modal" data-bs-target="#updateSiswaModal" class="btn btn-sm btn-square btn-neutral text-danger-hover">

												</button>
												<a href="<?php echo base_url(); ?>index.php/deleteSiswa/<?= $item->id ?>" class="btn btn-sm btn-square btn-neutral text-danger-hover">
					...
					<div class="modal fade" id="siswaModal" tabindex="-1" aria-labelledby="siswaModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="<?php echo base_url(); ?>index.php/registerSiswa" method="post">
									<div class="modal-body">
										...
										<div class="mb-3">
											...
											<input type="text" name="nisn" class="form-control" id="exampleFormControlInput1" placeholder="nisn">
										</div>
										<div class="mb-3">
										...
										<div class="mb-3">
											...
											<input type="text" name="no_telp" class="form-control" id="exampleFormControlInput1" placeholder="no telphone">
										</div>
